...
afc_but(1) = uicontrol('Parent', psylab_gui, ...
	'Unit','normalized', 'Position',[0.1 0.5 0.125 0.3], ...
	'Callback','M.UA=1;', ...
	'Tag','afc_answer1', ...
	'String','1', 'FontSize', 14);
afc_but(2) = uicontrol('Parent', psylab_gui, ...
	'Unit','normalized', 'Position',[0.325 0.5 0.125 0.3], ...
	'Callback','M.UA=2;', ...
	'Tag','afc_answer2', ...
	'String','2', 'FontSize', 14);
afc_but(3) = uicontrol('Parent', psylab_gui, ...
	'Unit','normalized', 'Position',[0.55 0.5 0.125 0.3], ...
	'Callback','M.UA=3;', ...
	'Tag','afc_answer3', ...
	'String','3', 'FontSize', 14);
afc_but(4) = uicontrol('Parent', psylab_gui, ...
	'Unit','normalized', 'Position',[0.775 0.5 0.125 0.3], ...
	'Callback','M.UA=4;', ...
	'Tag','afc_answer4', ...
