function [x, y] = display_psydat_raw_v2(s_name, exp_name, pstyle, param_perm) 

% analyse raw data in psydat-file and plot them
% ----------------------------------------------------------------------
% Usage: [x, y] = display_psydat_raw_v2(s_name, exp_name, pstyle, param_perm) 
%
...
% End of file:  display_psydat_raw_v2.m
